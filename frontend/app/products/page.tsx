...
function ProductPageContent() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE}/products/filter${qs ? `?${qs}` : ""}`)
      .then((res) => res.json())
  ...
  return (
    <div className="min-h-screen bg-[#b89f8d] px-6 py-8">
      {/* Header */}
      <div className="mb-1">
        <h1 className="text-3xl font-bold text-black">{t("products.title")}</h1>
        <div className="text-sm text-black/55">{t("products.subtitle")}</div>
      </div>
